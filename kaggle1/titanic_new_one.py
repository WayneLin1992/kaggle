# -*- coding: utf-8 -*-
"""
Created on Mon Apr 20 17:54:23 2020
...
#df['title'] = df['title'].map({'Miss': 0,'Mr': 1,'Mrs':2,'Master':3,'Misc':4})
...
df_1=df[['Pclass', 'Sex', 'Age','Embarked', 'Deck', 'FamilySize']].copy()
df_1 = df_1.values
...
classifier.add(Dense(units = 4,  activation = "relu", kernel_initializer = "uniform", input_dim = 6))
#
...
df_test['IsAlone'] = 1
df_test['IsAlone'].loc[df['FamilySize']>1] = 0
...
df_2=df_test[['Pclass', 'Sex', 'Age','Embarked', 'Deck', 'FamilySize']].copy()
df_2 = df_2.values
...
result.to_csv("Submission.csv1", index=False)